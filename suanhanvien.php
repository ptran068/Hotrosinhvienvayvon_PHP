...
if(isset($_POST["suaa"])) { 
    ...
    $sql = "UPDATE nhanvien SET Hoten='$name' , Diachi='$diachi', IDPB='$idpb' WHERE IDNV='$value'";
                    ...
                    <section class="box ">
                        ...
                        <div class="content-body">
                            ...
                            <div class="alert alert-success">
                                <strong>Sửa phòng ban thành công</strong>
                            </div>
                            <?php } ?>
                                ...
                                <div class="col-xs-12 col-sm-9 col-md-8 padding-bottom-30">
                                    ...
                                    <div class="col-xs-12 col-sm-9 col-md-8 padding-bottom-30">
                                        <div class="text-left">
                                            <button type="submit" name="suaa" class="btn btn-primary">Save</button>
                                            <input type="hidden" name="value"  value="<?php echo $_GET["IDNV"]?>"></td>
                                        </div>
                                    </div>
                                </form>
                                </div>
